...
static const char *fonts[] = {
	"Liberation Mono:pixelsize=16",
	"Twitter Color Emoji:pixelsize=14",
};
...
static char normhighfgcolor[] = "#ffffff";
static char normhighbgcolor[] = "#222222";
static char selhighfgcolor[] = "#ffffff";
static char selhighbgcolor[] = "#005577";
